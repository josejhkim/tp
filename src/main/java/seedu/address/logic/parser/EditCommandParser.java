...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_DIETARY_RESTRICTION).isPresent()) {
            editPersonDescriptor.setDietaryRestriction(
                    ParserUtil.parseDietaryRestriction(argMultimap.getValue(PREFIX_DIETARY_RESTRICTION).get()));
        }
        if (argMultimap.getValue(PREFIX_RSVP).isPresent()) {
            editPersonDescriptor.setRsvp(ParserUtil.parseRsvp(argMultimap.getValue(PREFIX_RSVP).get()));
        }
