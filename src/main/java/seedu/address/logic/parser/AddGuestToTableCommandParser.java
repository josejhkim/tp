 ...
 */
public class AddGuestToTableCommandParser implements Parser<AddGuestToTableCommand> {
    /**
     ...
     */
    @Override
    public AddGuestToTableCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_TABLE_ID)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                AddGuestToTableCommand.MESSAGE_USAGE));
        }
        ...
        return new AddGuestToTableCommand(name, tableId);
    }
