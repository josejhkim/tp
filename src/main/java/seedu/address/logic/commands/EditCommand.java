...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the person identified "
            ...
            + "TAG]... " + "[" + PREFIX_DIETARY_RESTRICTION + "DIETARY_RESTRICTION] " + "[" + PREFIX_TAG + "Tag1]" + "["
            + PREFIX_RSVP + "RSVP]\n"
            + "Example: " + COMMAND_WORD + " 1 " + PREFIX_PHONE + "91234567 " + PREFIX_TAG + "tag123 " + PREFIX_EMAIL
            + "johndoe@example.com "
            + PREFIX_DIETARY_RESTRICTION + "VEGETARIAN " + PREFIX_RSVP + "YES";
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        DietaryRestriction updatedDietaryRestriction = editPersonDescriptor.getDietaryRestriction()
                .orElse(personToEdit.getDietaryRestriction());

        Rsvp updatedRsvp = editPersonDescriptor.getRsvp().orElse(personToEdit.getRsvp());
        int updatedTableId = personToEdit.getTableId();
        return new Person(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedTags,
                updatedDietaryRestriction, updatedRsvp, updatedTableId);
    }
     ...
     * replace the corresponding field value
     * of the person.
     */
    public static class EditPersonDescriptor {
         ...
         * {@code UnsupportedOperationException} if modification is
